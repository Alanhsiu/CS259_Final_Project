// attention_tb.sv  (four 4×4 variant — interface identical to original)
...
module attention_tb;
    ...
    task automatic run_test2();
        logic [7:0]          Q_raw [0:511];
        logic [7:0]          K_raw [0:511];
        logic signed [31:0]  c_exp [0:N*N-1];

        logic [7:0]          Q_sl  [0:N-1][0:N-1];
        logic [7:0]          KT_sl [0:N-1][0:N-1];
        logic [7:0]          V_eye [0:N-1][0:N-1];
